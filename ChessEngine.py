...
class Move:
    # Trong cờ vua, các ô trên bàn cờ được mô tả bằng hai ký hiệu:
    # một ký hiệu là số từ 1 đến 8 (tương ứng với các hàng),
    # và ký hiệu còn lại là chữ cái từ a đến h (tương ứng với các cột).
    # Vì vậy, để sử dụng cách ký hiệu này, chúng ta cần ánh xạ tọa độ [row][col] trong chương trình
    # sao cho phù hợp với hệ tọa độ được dùng trong cờ vua truyền thống.
